...
const commentSchema = new Schema ({
    ...
    author: {
        type: mongoose.Schema.Types.ObjectId, //instead of a string this is a reference to the user document
        ref: 'User' //holds the reference for the model of this user document
    } 
    }   , {
            timestamps: true
})
